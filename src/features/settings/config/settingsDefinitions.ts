...
import type { SettingsCategory, SettingsFieldDefinition } from '../types/settings';
 ...
 */
export function getFieldByKey(key: string): { category: SettingsCategory; field: SettingsFieldDefinition } | undefined {
